...
def get_backbone_network(type='hamer'):
    if type in ['hamer']:
        from ..models.backbone.backbone_hamer_style import ViT_HaMeR
        backbone = ViT_HaMeR()
        ...
        from ..models.backbone.hrnet import HighResolutionNet
        from ..utils.func_utils import load_config
...
def get_decoder_network(type='hamer'):
    from ..models.decoder.decoder_hamer_style import ContactTransformerDecoderHead
