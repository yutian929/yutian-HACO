...
if __name__ == "__main__":
    ...
    detector_path = '../data/base_data/demo_data/wilor_detector.pt'  # Path to WILOR detector model
    ...
    checkpoint_path = '../release_checkpoint/haco_final_hamer_checkpoint.ckpt'  # Path to HACO model checkpoint
    ...
    input_path = '../asset/example_images'  # Input directory or single image path
    ...
    print(f"BASE_DATA_PATH: {cfg.BASE_DATA_PATH}")
    print(f"Human model path: {cfg.MODEL.human_model_path}")
    print(f"Contact data path: {cfg.MODEL.contact_data_path}")
    print(f"Hamer backbone path: {cfg.MODEL.hamer_backbone_pretrained_path}")
